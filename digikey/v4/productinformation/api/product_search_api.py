...
class ProductSearchApi:
    ...
    def alternate_packaging_with_http_info(self, product_number, x_digikey_client_id, **kwargs):
        ...
        if "product_number" not in params or params["product_number"] is None:
            raise ValueError(
                "Missing the required parameter `product_number` when calling `alternate_packaging`"
            )
        ...
        if "x_digikey_client_id" not in params or params["x_digikey_client_id"] is None:
            raise ValueError(
                "Missing the required parameter `x_digikey_client_id` when calling `alternate_packaging`"
            )
        ...
        if "product_number" in params:
            path_params["productNumber"] = params["product_number"]
        ...
        auth_settings = ["apiKeySecurity", "oauth2ApplicationSecurity"]
        ...
        return self.api_client.call_api(
            ...
            response_type="AlternatePackagingResponse",
    ...
    def associations_with_http_info(self, product_number, x_digikey_client_id, **kwargs):
        ...
        if "product_number" not in params or params["product_number"] is None:
            raise ValueError(
                "Missing the required parameter `product_number` when calling `associations`"
            )
        # verify the required parameter 'x_digikey_client_id' is set
        if "x_digikey_client_id" not in params or params["x_digikey_client_id"] is None:
            raise ValueError(
                "Missing the required parameter `x_digikey_client_id` when calling `associations`"
            )
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type="ProductAssociationsResponse",
            auth_settings=auth_settings,
            async_req=params.get("async_req"),
            _return_http_data_only=params.get("_return_http_data_only"),
            _preload_content=params.get("_preload_content", True),
    ...
    def categories_by_id_with_http_info(self, category_id, **kwargs):
        ...
        :return: CategoryResponse
                 ...
                 returns the request thread.
        """
        all_params = ["category_id", "authorization"]
        all_params.append("async_req")
        all_params.append("_return_http_data_only")
        all_params.append("_preload_content")
        all_params.append("_request_timeout")
        ...
        if "category_id" not in params or params["category_id"] is None:
            raise ValueError(
                "Missing the required parameter `category_id` when calling `categories_by_id`"
            )
    ...
    def digi_reel_pricing_with_http_info(
        ...
        if "product_number" not in params or params["product_number"] is None:
            raise ValueError(
                "Missing the required parameter `product_number` when calling `digi_reel_pricing`"
            )
    ...
    def keyword_search_with_http_info(self, x_digikey_client_id, **kwargs):
        ...
        all_params = [
            ...
            "body",
            "authorization",
            "x_digikey_locale_site2",
            "x_digikey_locale_language2",
            "x_digikey_locale_currency2",
            "x_digikey_customer_id",
            "x_digikey_locale_site",
            "x_digikey_locale_language",
            "x_digikey_locale_currency",
    ...
    def manufacturers_with_http_info(self, x_digikey_client_id, **kwargs):
        ...
        if "x_digikey_client_id" not in params or params["x_digikey_client_id"] is None:
            raise ValueError(
                "Missing the required parameter `x_digikey_client_id` when calling `manufacturers`"
            )
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type="ManufacturersResponse",
            auth_settings=auth_settings,
            async_req=params.get("async_req"),
            _return_http_data_only=params.get("_return_http_data_only"),
            _preload_content=params.get("_preload_content", True),
    ...
    def media_with_http_info(self, product_number, x_digikey_client_id, **kwargs):
        ...
        # verify the required parameter 'product_number' is set
        if "product_number" not in params or params["product_number"] is None:
            raise ValueError("Missing the required parameter `product_number` when calling `media`")
        # verify the required parameter 'x_digikey_client_id' is set
        if "x_digikey_client_id" not in params or params["x_digikey_client_id"] is None:
            raise ValueError(
                "Missing the required parameter `x_digikey_client_id` when calling `media`"
            )
    ...
    def package_type_by_quantity_with_http_info(
        ...
        if "product_number" not in params or params["product_number"] is None:
            raise ValueError(
                "Missing the required parameter `product_number` when calling `package_type_by_quantity`"
            )
        # verify the required parameter 'requested_quantity' is set
        if "requested_quantity" not in params or params["requested_quantity"] is None:
            raise ValueError(
                "Missing the required parameter `requested_quantity` when calling `package_type_by_quantity`"
            )
        # verify the required parameter 'x_digikey_client_id' is set
        if "x_digikey_client_id" not in params or params["x_digikey_client_id"] is None:
            raise ValueError(
                "Missing the required parameter `x_digikey_client_id` when calling `package_type_by_quantity`"
            )
        ...
        if "packaging_preference" in params:
            query_params.append(("packagingPreference", params["packaging_preference"]))
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type="PackageTypeByQuantityResponse",
            auth_settings=auth_settings,
            async_req=params.get("async_req"),
            _return_http_data_only=params.get("_return_http_data_only"),
            _preload_content=params.get("_preload_content", True),
    ...
    def product_details_with_http_info(self, product_number, x_digikey_client_id, **kwargs):
        ...
        if "product_number" not in params or params["product_number"] is None:
            raise ValueError(
                "Missing the required parameter `product_number` when calling `product_details`"
            )
        # verify the required parameter 'x_digikey_client_id' is set
        if "x_digikey_client_id" not in params or params["x_digikey_client_id"] is None:
            raise ValueError(
    ...
    def product_pricing_with_http_info(self, product_number, x_digikey_client_id, **kwargs):
        ...
        if "product_number" not in params or params["product_number"] is None:
            raise ValueError(
                "Missing the required parameter `product_number` when calling `product_pricing`"
            )
        # verify the required parameter 'x_digikey_client_id' is set
        if "x_digikey_client_id" not in params or params["x_digikey_client_id"] is None:
            raise ValueError(
                "Missing the required parameter `x_digikey_client_id` when calling `product_pricing`"
            )
        ...
        if "in_stock" in params:
            query_params.append(("inStock", params["in_stock"]))
        if "exclude_marketplace" in params:
            query_params.append(("excludeMarketplace", params["exclude_marketplace"]))
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type="ProductPricingResponse",
            auth_settings=auth_settings,
            async_req=params.get("async_req"),
            _return_http_data_only=params.get("_return_http_data_only"),
            _preload_content=params.get("_preload_content", True),
    ...
    def recommended_products_with_http_info(self, product_number, x_digikey_client_id, **kwargs):
        ...
        if "product_number" not in params or params["product_number"] is None:
            raise ValueError(
                "Missing the required parameter `product_number` when calling `recommended_products`"
            )
        # verify the required parameter 'x_digikey_client_id' is set
        if "x_digikey_client_id" not in params or params["x_digikey_client_id"] is None:
            raise ValueError(
                "Missing the required parameter `x_digikey_client_id` when calling `recommended_products`"
            )
        ...
        if "search_option_list" in params:
            query_params.append(("searchOptionList", params["search_option_list"]))
        if "exclude_market_place_products" in params:
            query_params.append(
                ("excludeMarketPlaceProducts", params["exclude_market_place_products"])
            )
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type="RecommendedProductsResponse",
            auth_settings=auth_settings,
            async_req=params.get("async_req"),
            _return_http_data_only=params.get("_return_http_data_only"),
            _preload_content=params.get("_preload_content", True),
    ...
    def substitutions_with_http_info(self, product_number, x_digikey_client_id, **kwargs):
        ...
        if "product_number" not in params or params["product_number"] is None:
            raise ValueError(
                "Missing the required parameter `product_number` when calling `substitutions`"
            )
        # verify the required parameter 'x_digikey_client_id' is set
        if "x_digikey_client_id" not in params or params["x_digikey_client_id"] is None:
            raise ValueError(
                "Missing the required parameter `x_digikey_client_id` when calling `substitutions`"
            )
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type="ProductSubstitutesResponse",
            auth_settings=auth_settings,
            async_req=params.get("async_req"),
            _return_http_data_only=params.get("_return_http_data_only"),
            _preload_content=params.get("_preload_content", True),
