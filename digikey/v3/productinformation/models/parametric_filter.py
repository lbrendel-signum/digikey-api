...
class ParametricFilter:
    ...
    """
    swagger_types = {"parameter_id": "int", "value_id": "str"}

    attribute_map = {"parameter_id": "ParameterId", "value_id": "ValueId"}

    def __init__(self, parameter_id=None, value_id=None) -> None:
        """ParametricFilter - a model defined in Swagger"""
    ...
    def parameter_id(self, parameter_id) -> None:
        ...
        :type: int
        """
        if parameter_id is not None and parameter_id > 2147483647:
            raise ValueError(
                "Invalid value for `parameter_id`, must be a value less than or equal to `2147483647`"
            )
        if parameter_id is not None and parameter_id < -2147483648:
            raise ValueError(
                "Invalid value for `parameter_id`, must be a value greater than or equal to `-2147483648`"
            )
    ...
    def value_id(self, value_id) -> None:
        ...
        if value_id is not None and len(value_id) > 100:
            raise ValueError(
                "Invalid value for `value_id`, length must be less than or equal to `100`"
            )
        if value_id is not None and len(value_id) < 1:
            raise ValueError(
                "Invalid value for `value_id`, length must be greater than or equal to `1`"
            )
