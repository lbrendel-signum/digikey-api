...
class SortParameters:
    ...
    def __init__(self, sort_option=None, direction=None, sort_parameter_id=None) -> None:
        """SortParameters - a model defined in Swagger"""
    ...
    @sort_option.setter
    def sort_option(self, sort_option) -> None:
        """
        ...
        if sort_option is None:
            raise ValueError("Invalid value for `sort_option`, must not be `None`")
    ...
    def sort_parameter_id(self, sort_parameter_id) -> None:
        """
