...
class BatchProductDetailsRequest(object):
    ...
    """
    swagger_types = {"products": "list[str]"}

    attribute_map = {"products": "Products"}

    def __init__(self, products=None):  # noqa: E501
        """BatchProductDetailsRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BatchProductDetailsRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchProductDetailsRequest):
            return False
