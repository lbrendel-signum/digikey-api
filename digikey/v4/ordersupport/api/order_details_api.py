...
class OrderDetailsApi:
    ...
    def order_history_with_http_info(self, authorization, x_digikey_client_id, **kwargs):
        ...
        if "authorization" not in params or params["authorization"] is None:
            raise ValueError(
                "Missing the required parameter `authorization` when calling `order_history`"
            )
        ...
        if "x_digikey_client_id" not in params or params["x_digikey_client_id"] is None:
            raise ValueError(
                "Missing the required parameter `x_digikey_client_id` when calling `order_history`"
            )
        ...
        if "open_only" in params:
            query_params.append(("OpenOnly", params["open_only"]))
        if "include_company_orders" in params:
            query_params.append(("IncludeCompanyOrders", params["include_company_orders"]))
        ...
        return self.api_client.call_api(
            ...
            response_type="list[SalesOrderHistoryItem]",
    ...
    def order_status_with_http_info(
        ...
        if "sales_order_id" not in params or params["sales_order_id"] is None:
            raise ValueError(
                "Missing the required parameter `sales_order_id` when calling `order_status`"
            )
        # verify the required parameter 'authorization' is set
        if "authorization" not in params or params["authorization"] is None:
            raise ValueError(
                "Missing the required parameter `authorization` when calling `order_status`"
            )
        # verify the required parameter 'x_digikey_client_id' is set
        if "x_digikey_client_id" not in params or params["x_digikey_client_id"] is None:
            raise ValueError(
                "Missing the required parameter `x_digikey_client_id` when calling `order_status`"
            )
        ...
        if "sales_order_id" in params:
            path_params["salesOrderId"] = params["sales_order_id"]
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type="OrderStatusResponse",
            auth_settings=auth_settings,
            async_req=params.get("async_req"),
            _return_http_data_only=params.get("_return_http_data_only"),
            _preload_content=params.get("_preload_content", True),
