...
class ManufacturerProductDetailsRequest:
    """
    ...
    def manufacturer_product(self, manufacturer_product):
        ...
        if manufacturer_product is None:
            raise ValueError("Invalid value for `manufacturer_product`, must not be `None`")
        ...
        if manufacturer_product is not None and len(manufacturer_product) < 1:
            raise ValueError(
                "Invalid value for `manufacturer_product`, length must be greater than or equal to `1`"
            )
    ...
    def record_count(self, record_count):
        ...
        :type: int
        """
        if record_count is not None and record_count > 50:
            raise ValueError(
                "Invalid value for `record_count`, must be a value less than or equal to `50`"
            )
        if record_count is not None and record_count < 1:
            raise ValueError(
                "Invalid value for `record_count`, must be a value greater than or equal to `1`"
            )
